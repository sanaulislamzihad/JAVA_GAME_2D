...
/** Collectible gem that adds time to the level. সবসময় নীল রঙে দেখা যাবে। */
public class TimeGem extends KeyObject {

    public static final int TIME_SECONDS = 15;

    public TimeGem() {
        name = "TimeGem";
        try {
            java.io.InputStream s = getClass().getResourceAsStream("/gem/time.png");
